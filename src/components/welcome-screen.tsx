            ...
            <Card className="w-full max-w-2xl mx-auto text-center shadow-lg">
                ...
                <CardContent className="space-y-6 p-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-8">
                        <div className="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent/10 transition-colors cursor-pointer">
                            <FolderPlus className="w-10 h-10 text-primary" />
                            <p className="text-sm font-medium">Create a New Case</p>
                            <p className="text-xs text-muted-foreground">Start from scratch.</p>
                        </div>
                        <div 
                            className="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent/10 transition-colors cursor-pointer"
